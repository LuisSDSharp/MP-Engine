...
void EventManager::SendEventToHandler(EventID eventId, IEventHandler& eventHandler)
{
	EventMapIterator result = m_eventMap.find(eventId);
	if (result != m_eventMap.end())
	{
...
void EventManager::AttachEvent(EventID eventId, IEventHandler& eventHandler)
{
	EventMapIterator result = m_eventMap.find(eventId);
...
void EventManager::DetachEvent(EventID eventId, IEventHandler& eventHandler)
{
	EventMapIterator result = m_eventMap.find(eventId);
	assert(result != m_eventMap.end());
	if (result != m_eventMap.end())
